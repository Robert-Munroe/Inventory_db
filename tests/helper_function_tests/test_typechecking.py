...
def test_correct_entry():
    ...
    assert message == "FSG ID is invalid or blank, product field is blank, "

    message = typechecking.is_entry_correct("", "", "", holding_location, description, quantity, unit)
    assert message == "FSG ID is invalid or blank, product field is blank, the client ID is blank, "

    message = typechecking.is_entry_correct("", "", "", "", description, quantity, unit)
    assert message == "FSG ID is invalid or blank, product field is blank, the client ID is blank, " \
                      "storage location is blank, "

    message = typechecking.is_entry_correct("", "", "", "", "", quantity, unit)
    assert message == "FSG ID is invalid or blank, product field is blank, the client ID is blank," \
                      " storage location is blank, container description is blank, "

    message = typechecking.is_entry_correct("", "", "", "", "", "", unit)
    assert message == "FSG ID is invalid or blank, product field is blank, the client ID is blank," \
                      " storage location is blank, container description is blank," \
                      " product's quantity is not set, or not a valid number, "

    message = typechecking.is_entry_correct("", "", "", "", "", "", "")
    assert message == "FSG ID is invalid or blank, product field is blank, the client ID is blank," \
                      " storage location is blank, container description is blank," \
                      " product's quantity is not set, or not a valid number, product's units are invalid or not set"
